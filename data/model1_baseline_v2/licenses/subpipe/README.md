# SubPipe license evidence review

- Review date: `2026-08-26` (Europe/Istanbul)
- Record: <https://zenodo.org/records/12666132>
- API metadata: <https://zenodo.org/api/records/12666132>
- DOI: `10.5281/zenodo.12666132`
- Version: `3.0.1`
- Publication date: `2024-07-05`
- Resource type: dataset
- Access observed: public record with downloadable files
...
## Published files observed

| File | Bytes | Published checksum |
|---|---:|---|
| `SubPipeMini2.zip` | 4,945,761,374 | `md5:7e0d925f93a89bc0e8715e4f6f7caecb` |
| `SubPipeMini.zip` | 6,078,303,615 | `md5:399c08359bf1e2f779f6d7d9bdbfb43a` |
| `SubPipe.zip` | 28,011,923,314 | `md5:0af8d8231a4c09b2b3303e44765ae8d6` |
