# CleanCam license and version evidence review

- Review date: `2026-08-26` (Europe/Istanbul)
- Current record: <https://zenodo.org/records/21515620>
- API metadata: <https://zenodo.org/api/records/21515620>
- DOI: `10.5281/zenodo.21515620`
- Version: `v2.0.0`
- Publication date: `2026-07-23`
- Resource type: dataset
- Superseded record reviewed: <https://zenodo.org/records/18952474> (`v1.0.0`)
- License observed in current API `metadata.rights`: `null`
...
Minh Khoa Nguyen; Tuan Anh Hoang; Nam Nhat Anh Tran; Nam Nguyet Anh Tran; Minh Hoang Pham; Tuan Khoi Phan; Van Dinh Nguyen; Van Dung Dinh; Danh Cuong Do.

## Current published file observed

| File | Bytes | Published checksum |
|---|---:|---|
| `CleanCam_v2.zip` | 2,440,389,951 | `md5:fbfc94abe9e91c1d405d544cdaa90c78` |
