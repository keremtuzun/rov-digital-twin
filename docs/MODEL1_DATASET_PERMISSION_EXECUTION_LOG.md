...
| SeaClear Marine Debris | <https://data.4tu.nl/datasets/4f1dff25-e157-4399-a5d4-478055461689/1> | 4TU.ResearchData / named creators | No separate request required | `ACQUIRED_LICENSE_VERIFIED_ASSET_REVIEW_PENDING` | CC BY 4.0 verified on canonical record and DataCite metadata | `data/model1_baseline_v2/licenses/seaclear/README.md`; publisher MD5 matched | No, pending manifest/split/approval | No, pending manifest/split/approval | Build asset manifest preserving site/camera groups; map only supported debris/contamination semantics |
...
2. Build and review the SeaClear asset manifest while preserving site/camera grouping and exact attribution.
